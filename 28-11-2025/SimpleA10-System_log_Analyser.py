...
with open("log_summary.txt", "w") as log_file:
    ...
    log_file.write(f"Number of ERROR lines: {count_error}\n")
    log_file.write(f"Number of WARNING lines: {count_warning}\n")
    log_file.write(f"Number of INFO lines: {count_info}")